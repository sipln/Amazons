...
def doit(move, state):
    ...
    # example: [(0,3),(5,3),(8,6)]
    if state[move[0][0]][move[0][1]] == '_w_':
        new_state[move[1][0]][move[1][1]] = '_w_'
    elif state[move[0][0]][move[0][1]] == '_b_':
        new_state[move[1][0]][move[1][1]] = '_b_'
    # new___state[move[0][0]][move[0][1]] = '.'
    new_state[move[0][0]][move[0][1]] = '___'
    new_state[move[2][0]][move[2][1]] = '_x_'
...
def play(student_a, student_b, start_state=Initial_Board):
    ...
    a = player_a.Player('_w_')
    b = player_b.Player('_b_')
